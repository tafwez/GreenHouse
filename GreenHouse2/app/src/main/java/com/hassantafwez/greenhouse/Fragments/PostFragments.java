...
import com.hassantafwez.greenhouse.Adapters.PostAdapter;
 ...
 * Use the {@link PostFragments#newInstance} factory method to
...
public class PostFragments extends Fragment {
     ...
     * @return A new instance of fragment PostFragments.
     */
    // TODO: Rename and change types and number of parameters
    public static PostFragments newInstance(String param1, String param2) {
        PostFragments fragment = new PostFragments();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_post_fragments, container, false);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i=0;i<response.length();i++)
                        {
                            try {
                                ...
                                PostAdapter photoAdapter=new PostAdapter(arrayList,getActivity().getApplicationContext());
